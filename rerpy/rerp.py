...
def test__epoch_subspans():
    ...
    t([s(-5, 10, e0, None),
      ...
      [(-5,  0, set([e0]), set()),
       ...
       ( 5,  7, set([e0, e1]), set(["a1"])),
       ( 7,  8, set([e0, e1]), set(["a1"])),
       ( 8, 10, set([e0, e1]), set(["a1"])),
       (10, 12, set([e1]), set()),
       (12, 15, set([e1, e_ia0]), set(["ia0"])),
       (15, 20, set([e_ia0]), set(["ia0"])),
       (30, 40, set([e_ia0_ia1]), set(["ia0", "ia1"])),
       ])
    t([s(-5, 10, e0, None),
       s( 0, 15, e1, None),
       s( 5,  8, None, "a1"),
