...
latex_documents = [
  ('index', 'pyrERP.tex', u'rERPy Documentation',
...
man_pages = [
    ('index', 'rERPy', u'rERPy Documentation',
...
texinfo_documents = [
  ('index', 'rERPy', u'rERPy Documentation',
   u'Nathaniel J. Smith', 'rERPy', 'A Python toolkit for doing ERP and rERP analysis of brainwave data',
   'Miscellaneous'),
]
